(defproject brasilparalelo "0.1.0-SNAPSHOT"

  :description "Brasil Paralelo OpenAPI"
  :url "https://github.com/korn/brasil-paralelo"
  ...
  :main ^:skip-aot brasilparalelo.core
  ...
  {:uberjar       {:omit-source    true
                   :aot            :all
                   :uberjar-name   "brasilparalelo.jar"
